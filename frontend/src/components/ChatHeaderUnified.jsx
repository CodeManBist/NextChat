...
const ChatHeaderUnified = ({
  ...
  return (
    <div className="h-16 sm:h-20 theme-panel border-b theme-border px-3 sm:px-5 py-2 sm:py-4 flex items-center justify-between shrink-0">
      ...
      <div className="flex items-center gap-3 min-w-0 flex-1">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className={`text-xs sm:text-sm ${
            isTyping && !isGroup ? "text-cyan-300" : "text-white/45"
          }`}>
            {subtitle}
          </p>
        </div>
