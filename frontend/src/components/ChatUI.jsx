    ...
    <div className="theme-shell h-full w-full overflow-hidden relative flex flex-col">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-15">
          <div className="absolute top-20 left-10 h-40 w-40 rounded-full border border-white/10" />
          <div className="absolute bottom-20 right-10 h-72 w-72 rounded-full border border-white/8" />
          <div className="absolute top-1/2 left-1/2 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/6" />
        </div>
      </div>
      ...
      >
        {isEmpty ? (
          <div className="h-full min-h-75 flex items-center justify-center text-white/45 text-center px-4 sm:px-6">
